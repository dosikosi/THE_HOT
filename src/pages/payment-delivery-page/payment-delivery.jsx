        ...
        <div className="payment_delivery_wrapper">
          ...
          <div className="delivery_section">
            ...
            <div className="delivery_descriptions">
              ...
              <p>
                Я осуществляю доставке по городу Таганрогу, Ростовской области и России.
                Удобный вариант доставки выбирается при оформлении заказа.
              </p>
              <h3>САМОВЫВОЗ</h3>
              <p>
                Пункт самовывоза находится по адресу: <span>123456789</span>{" "}
                Россия, Таганрог, Заказная д.<span>47</span> стр.
                <span>3</span> , подъезд №<span>3</span>
                Выдача производится на следующий день после оформления
                заказа ПН-ПТ с <span>09-00 до 17-00</span>, СБ-ВС выходной
              </p>
              <h3>Доставка курьерской службой:</h3>
              <p>
                Курьерская доставка по Таганрогу и области в течении{" "}
                <span>3</span>-х дней с момента оплаты. Стоимость{" "}
                <span>400</span> рублей.
                <br />
                <br />
                Доставка по России осуществляется через СДЭК и Почта
